...
myApp.controller('LoginCont', function ($scope, $rootScope, AUTH_EVENTS, AuthService) {
  $scope.credentials = {
    username: '',
    password: ''
  };
...
myAppmyApp.factory('AuthService', function ($http, Session) {
  var authService = {};
...
myApp.factory('AuthResolver', function ($q, $rootScope, $state) {
  return {
    resolve: function () {
